package be.pxl.troger.nativeAR.views;
...
import be.pxl.troger.nativeAR.R;
import be.pxl.troger.nativeAR.MyActivity;
...
public class CameraPreviewView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    static
    {
        System.loadLibrary("opencv_java3"); // works not without on Vuzix MX100
