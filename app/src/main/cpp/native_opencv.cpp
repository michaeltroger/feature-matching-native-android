...
extern "C" {
    void
    Java_com_michaeltroger_featureMatchingNative_views_CameraPreviewView_InitTemplateImage(JNIEnv *env, jobject instance,
    ...
    jboolean
    Java_com_michaeltroger_featureMatchingNative_views_CameraPreviewView_ImageProcessing(
